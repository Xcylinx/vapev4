...
local function GetURL(scripturl)
	if shared.VapeDeveloper then
		...
		local res = game:HttpGet("https://raw.githubusercontent.com/Xcylinx/vapev4/main/"..scripturl, true)
...
local function getcustomassetfunc(path)
	if not betterisfile(path) then
		...
		local req = requestfunc({
			Url = "https://raw.githubusercontent.com/Xcylinx/vapev4/main/"..path:gsub("vape/assets", "assets"),
			Method = "GET"
		})
